...
import value from './defaultValue.json';
import valueSecond from './defaultValue.json';
...
class Default extends React.Component {
  state = {
    ...
    // value: serializer.deserialize('<p align="left" style="font-size:17px">dhghgfh</p><p align="left" style="font-size:17px">fdgdfgd<br/>dsfsdfsdf</p><p align="left" style="font-size:17px">sdfsdfsdfsdfd</p><p align="left" style="font-size:17px"></p>'),
    valueSecond: Value.fromJSON({
      document: {
        nodes: [
          {
            object: 'block',
  ...
  render() {
    return (
      <div>
         <div>
      <App fontId="Editor1" value={this.state.value} onChange={this.onChange} gallery={{listImages: this.getImages, addImage: this.insertImage}}>
        <Menubar>
      ...
      <div>
      <App fontId="Editor2" value={this.state.valueSecond} onChange={this.onChangeSecond}>
        <Menubar>
          <MenuItem>File</MenuItem>
          <MenuItem>Help</MenuItem>
        </Menubar>
